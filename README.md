...
* **Get stage tilemap**: Generate stage tile map from prefab file. Big prefabs (> 5 MB) have slow parse. (WIP; currently
  generating with bad tile placing, and some packed sprite sheets are unable to find.)
